...
¡ñ Cross-language, cross-platform, currently supports C #, Java, C ++, JavaScript  
¡ñ High efficiency and concurrency (millions of concurrency), QPS:2 million  
¡ñ Lightweight and simple, JavaScript access, less than 1000 lines of code, only 8KB after compression  
¡ñ Easy to expand, can expand access  
¡ñ Support IOCP, ZMQ, WebSocket, NamedPipe, SharedMemory and other communication methods  
¡ñ No code intrusion, NET Core only takes 1 line of code to join the service center  

...
; (function (scope) {
    ...
    obj.environmentConfig = {
        fileName: 'Sers-localhost.postman_environment.json',
        value: {
    ...
    function apiDescToPostmanItem(apiDesc, index) {
        ...
        var item = {
            "name": "x." + (1 + parseInt(index)) + " " + route,
            "request": {
                "method": obj.collectionConfig.method,
                "header": [
                    {
                        "key": "Authorization",
                        "value": "Bearer {{At}}",
                ...
                "body": {
                    ...
                    "raw": JSON.stringify(sers.ssModel.getExampleBySsModel(apiDesc['argType']), null, 2)
                },
                "url": {

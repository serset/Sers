...
VsTool.exe replace -r --file "*.csproj" --old "%version%" --new "%newVersion%"
VsTool.exe replace -r --file "packages.config" --old "%version%" --new "%newVersion%"

VsTool.exe replace -r --path "Sers\dotnet\Doc\PublishFile\SersDocker" --file "*.txt" --old "%version%" --new "%newVersion%"

...
namespace Sers.Apm.SkyWalking.Core.Base
{
    public class ConfigAccessor : IConfigAccessor
    {
        ...
        public static IConfigurationBuilder AddSkyWalkingDefaultConfig(IConfigurationBuilder builder)
        {            
            return builder.AddInMemoryCollection(SkyWalkingManage.config);
        }
        ...
        public ConfigAccessor(/*IEnvironmentProvider environmentProvider*/)
        {
            ...
            AddSkyWalkingDefaultConfig(builder);

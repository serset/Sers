...
namespace Sers.Core.Module.SsApiDiscovery
{
    public class SsApiDiscovery : ISersDiscovery
    {
                ...
                foreach (var type in types)
                {
                    ...
                    {                        
                        ...
                        foreach (var method in methods)
                        {
                            ...
                            {
                                if (apiDesc == null) apiDesc = sampleApiDesc.Clone();
        ...
        protected virtual List<String> GetStationName(DiscoveryConfig config, Type type)
        {
            ...
            stationNames = ConfigurationManager.Instance.GetByPath<List<String>>("Sers.LocalApiService.SersApiDiscovery.apiStationName");
            return stationNames;
        ...
        protected virtual SsApiDesc DiscoveryApiDesc(MethodInfo method)
        {
            ...
            apiDesc.rpcVerify2 = ApiRpcVerify2.GetRpcVerify2FromMethod(method);

...
namespace Sers.Core.Extensions
{
    public static partial class ObjectSerializeExtensions
    {
        ...
        {
            return Serialization.Instance.Serialize(value).BytesToArraySegmentByte();
        }
        #endregion
        ...
        public static object DeserializeFromBytes(this ArraySegment<byte> value, Type type)
        { 
            return Serialization.Instance.Deserialize(value,type);
        }
        #endregion

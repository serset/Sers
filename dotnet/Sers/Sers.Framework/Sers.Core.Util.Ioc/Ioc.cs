...
namespace Sers.Core.Util.Ioc
{
    public class Ioc
    {
        ...
        public ServiceCollection rootServiceCollection { get; private set; }
  
        private IServiceProvider _rootServiceProvider;
        IServiceProvider rootServiceProvider => (_rootServiceProvider ?? (_rootServiceProvider = rootServiceCollection.BuildServiceProvider()));
        ...
        class ScopeCache : IDisposable
        {
            ...
            public void Dispose()
            {
                lock (ioc)
                {
                    ...
                    {                        
                        throw new Exception($"did not call IServiceScope.Dispose in order[Sers.Core.Util.Ioc,{ nameof(Ioc) }.cs,Line {GetFileLineNumber()}]");
        ...
        public Ioc(ServiceCollection serviceCollection = null)
        {

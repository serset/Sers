...
namespace App.StationDemo.Station.Controllers.Demo
{
        ...
        : IApiController
    {
        ...
        public ApiReturn<Object> RpcReplyDemo([SsArgEntity,SsExample("requestContent")]string request)
        {
            ...
            //header["Content-Type"] = "application/json";ss是是是是
        ...
        public ApiReturn<Object> ApiClient1(
            [SsExample("/DemoStation/v1/3/arg/32")]string apiRoute, 
        ...
        {
            var apiRet = ApiClient.CallRemoteApi<ArraySegment<byte>>("/DemoStation/v1/api/6/ApiClient/2_1", new byte[] { 3, 2, 3, 4, 5 });
            return new ApiReturn();
        }
        #endregion
        ...
        {
            var apiRequestMessage = new ApiMessage().InitAsApiRequestMessage("/JDemoStation/v1/6/ApiClient/3_1", null);
        ...
        /// <returns></returns>
        [SsRoute("8/valid2/1")]
        [SsEqual(path = "caller.source", value = "Internal", errorMessage = "权限限制(没有权限)")]
        [SsRequired(path = "caller.source", errorMessage = "权限限制(没有权限)")]
